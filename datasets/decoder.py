    ...
    if two_token:
        ...
        if rand_fr:
            if num_frames == 8:
                ...
                global_1 = temporal_sampling(frames, 0, max_len - 5, max(num_frames // 2, 1))
                global_2 = temporal_sampling(frames, 5, max_len, num_frames)

            local_samples = []
            local_width = max_len // 8

            if num_frames == 8:
                num_local_frames = [1, 1, 2, 2, 4, 4, 8, 8]
            elif num_frames == 16:
                ...
                num_local_frames = [max(num_frames // 8, 1)] * 8
